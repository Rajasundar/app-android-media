...
public class RecentlyAddedVideoLazyAdapter extends BaseAdapter {
	...
	public RecentlyAddedVideoLazyAdapter(android.app.Activity context, int w,
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null)
			dynamicView = inflater.inflate(R.layout.video_data_view, null);
