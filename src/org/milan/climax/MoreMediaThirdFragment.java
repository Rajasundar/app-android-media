...
public class MoreMediaThirdFragment extends Fragment implements OnClickListener {
	...
	public MoreMediaThirdFragment(String currentFilePath, String categoryMedia, DrawerLayout mDrawerLayout) {
											...
											if (name1.equalsIgnoreCase("label")) {
												...
												if(fileType.equalsIgnoreCase("file")){
													...
													tableRow.setOnClickListener(new OnClickListener() {
														...
														public void onClick(View v) {
															// TODO Auto-generated method stub
															String requestStr = "{\"jsonrpc\":\"2.0\",\"method\":\"Player.Open\",\"id\":1,\"params\":{\"item\":{\"file\":\""+play+"\"}}}";
												...
												tableRow.setOnClickListener(new OnClickListener() {
													...
													public void onClick(View v) {
														...
														if(finalStringFileType.equalsIgnoreCase("directory")){
															Fragment newFragment = new MoreMediaThirdFragment(sendFilePath , typePlay, mDrawerLayout);
